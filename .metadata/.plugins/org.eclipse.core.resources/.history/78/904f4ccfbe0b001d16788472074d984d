...
public class CommissionEmployeeExtV3 extends Object{
	...
	public CommissionEmployeeExtV3(String fName,String lName,String idNumber,double grossSales,double CommissionRate) 
	{
		super();
		if(fName.equals("")) 
		{
	...
	public void setCommissionRate(double commissionRate) {
		...
		public double earnings() 
		{
			...
			//可直接在上面getGrossSales*1.1 return (this.grossSales *1.1) * getCommissionRate();
